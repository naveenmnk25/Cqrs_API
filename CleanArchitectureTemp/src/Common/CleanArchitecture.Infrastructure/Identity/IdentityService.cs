...
namespace CleanArchitecture.Infrastructure.Identity
{
    public class IdentityService : IIdentityService
    {
        ...
        public IdentityService(UserManager<Entity.ApplicationUser> userManager, IMapper mapper, IApplicationDbContext context)
        {
            _userManager = userManager;
            _mapper = mapper;
            _context = context;
        ...
        {
            var user = await _context.User.Where(x => x.Username == email).FirstOrDefaultAsync();
